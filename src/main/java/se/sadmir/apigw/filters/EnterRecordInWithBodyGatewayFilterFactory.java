 ...
 */
@Component
public class EnterRecordInWithBodyGatewayFilterFactory
        extends AbstractGatewayFilterFactory<EnterRecordInWithBodyGatewayFilterFactory.Config> {

    final Logger logger = LoggerFactory.getLogger(EnterRecordInWithBodyGatewayFilterFactory.class);
    public static final String CORRELATION_ID_KEY = "skv-correlation-id";

    private final List<HttpMessageReader<?>> messageReaders;

    public EnterRecordInWithBodyGatewayFilterFactory() {
        super(Config.class);
        this.messageReaders = HandlerStrategies.withDefaults().messageReaders();
    }

    @Deprecated
    public EnterRecordInWithBodyGatewayFilterFactory(ServerCodecConfigurer codecConfigurer) {
        this();
    }
